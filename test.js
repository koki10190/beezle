...
async function set() {
	const set_rs = await axios.post(`https://722b-95-83-232-242.ngrok-free.app /rpc/set`, {
		apiKey: dapi_key,
	...
	// to unset
	const unset_res = await axios.post(`https://722b-95-83-232-242.ngrok-free.app /rpc/unset`, {
		apiKey: dapi_key,
	});
}
