...
function Display({ isOpen, user }: { isOpen: boolean; user: UserType }) {
	...
	const authSpotify = async () => {
		...
		const redirectURI = "https://0630-95-83-232-242.ngrok-free.app";
